...
public class CollinearTest {
	...
	public void testBinaryTrue() {
		...
		assertEquals("testing", true, Collinear.binarySearch(a1, x));

	}
	/*
	 * Test to see if binary search returns false when number is not on the list.
	 */
	...
	public void testBinaryFalse() {
		...
		assertEquals(expectedResult, Collinear.binarySearch(a1, x));
	...
	public void testBinary() {
		...
		assertEquals(expectedResult, Collinear.binarySearch(a2, x));		
	}
